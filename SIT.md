...
#### [5789]
半角の5,7,8,9のいずれか一文字を示しています。  
#### \w
[A-Za-z0-9] と同等で半角英数1文字を示しています。  
#### (?<!\w|[－ー―-]|- )
他の部分がマッチした後、前に半角の英数字やハイフンがないことを確認する正規表現のアサーションとなっており、電話番号の形式を部分的に含む、E03-0000-0000のようなシリアル コードなどの類似する文字列を排除するようにしています。  
#### (?!\w|[－ー―-]| -)
他の部分がマッチした後、後ろに半角の英数字やハイフンがないことを確認する正規表現のアサーションとなっており、電話番号の形式を部分的に含む、03-0000-0000-0000のようなシリアル コードなどの類似する文字列を排除するようにしています。
